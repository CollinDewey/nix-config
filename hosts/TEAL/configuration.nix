...
in
{
  ...
  services = {
    ...
    nfs.server = {
      enable = true;
      exports = ''
        / 172.16.1.0/24(${nfs_opts_rw},crossmnt) 172.16.1.0/24(${nfs_opts_rw},crossmnt)
        /snapshots 172.16.1.0/24(${nfs_opts_ro}) 172.16.1.0/24(${nfs_opts_ro})
        /services 172.16.1.0/24(${nfs_opts_rw}) 172.16.1.0/24(${nfs_opts_rw})
        /cyber 172.16.1.0/24(${nfs_opts_rw}) 172.16.1.0/24(${nfs_opts_rw})
        /storage 172.16.1.0/24(${nfs_opts_rw}) 172.16.1.0/24(${nfs_opts_rw})
        /vm_storage 172.16.1.0/24(${nfs_opts_rw}) 172.16.1.0/24(${nfs_opts_rw})
        /network_share/Global 172.16.0.0/12(${nfs_opts_rw}) 172.16.1.0/24(${nfs_opts_rw})
        /network_share/CMD 172.16.1.0/24(${nfs_opts_rw}) 172.16.1.0/24(${nfs_opts_rw})
